...
We will work in branches so as to not overwrite each other’s work and have a systematic way in introducing new contributions to the book. Coordinating collaborative changes on branches is what GitHub does best.
...
A nice clean workflow with branches is to consider them temporary. 

A written overview of the contributing workflow looks like this:

1. You pull the most recent from `main`
...
Now we will practically walk through this workflow here:
