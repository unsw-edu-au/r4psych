...
First things first, let's make sure we have the latest version of [Quarto](https://quarto.org/docs/get-started/) installed.
...
Instead, we suggest using a git client like [Github Desktop](https://desktop.github.com/), however it is limited to only to Windows and Mac. If you use Linux, [GitKraken](https://www.gitkraken.com/git-client) is also a great alternative.
...
The best way to contribute to the book is to create an independent copy that lives in your Github account. This process is called **creating a fork** and it allows you to take your time to make your contributions without it affect the current version of the book. 
...
We will work in branches so as to not overwrite each other’s work and have a systematic way in introducing new contributions to the book. Coordinating collaborative changes on branches is what GitHub does best. A nice clean workflow with branches is to consider them temporary. 

The `main` branch will be the current approved version of the book. The `main` branch is what is displayed at https://unsw-edu-au.github.io/r4psych/

Here's an overview of the contributing workflow looks like:

1. You fork the most recent version from `main`

2. You **create a branch locally**

3. You make your edits, you **commit** regularly, you **push** regularly to the remote (github.com)

4. When you are happy with your changes, you will create a **pull request** for your contribution and one of the core maintainers will review it. Edits may be requested or one of the maintainers will make the changes after having a conversation with you. 
...
### Can I make a contribution without using Git?
